...
if($filas_1){
 ...
 <style>
    ...
    <h4 class="title-" style="margin-left:15px; ">Nombres y Apellidos: <a class="des" >  <?php echo $filas_1['nombre'] ?> <span> <?php echo $filas_1['apellido'] ?></span> </a></h4>
    <h4 class="title-" style="margin-left:15px; ">Cedula: <a  class="des"> <?php echo $filas_1['cedula'] ?> </a></h4>
    <h4 class="title-" style="margin-left:15px; ">Correo: <a  class="des"> <?php echo $filas_1['correo'] ?></a> </h4>
    <h4 class="title-" style="margin-left:15px; ">Contacto: <a  class="des"> <?php echo $filas_1['contacto'] ?> </a> </h4>
...
<div class="estado">
      <?php
          ...
          // cremos la consulta añadimos un alias a count(*)
            $totp= "SELECT count(*) total from documentos where id_estudiante = '$id_est';";
          ...
          if($total >=7){
            ...
            <button disabled type="button" class="btn btn-warning">Pendiente</button>
           <br>
            <?php
          }
      ?>
...
<div class="Mostrar"> 
  ...
  <?php 
   ...
   ?>
    ...
    if($asis){
      ?>
   <div style=" text-align: center;"> <img src="https://cdn-icons-png.flaticon.com/512/594/594806.png" alt="" height="100px" width="120px">
   <br> <?php echo'<a href="http://localhost/Oficial/modelo/'.$asis['archivo'].'" class="descarga" >Ver Documento</a></div>'?> 
   <?php
   } else{
    ?>
    <div style=" text-align: center;"> <img src="https://cdn.pixabay.com/photo/2012/04/13/00/21/button-31222_960_720.png" alt="" height="100px" width="120px">
  ...
  <?php 
   ...
   ?>
    ...
    <div class="inf vinculacion">
    <h3 class="Tarea">Cert. de Entidad Receptora</h3>

    <?php 
    $conexion_6= mysqli_connect("localhost", "root", "", "its");
    $vinculacion = "SELECT archivo FROM documentos WHERE id_estudiante= '$id_est' and titulo= 'Certificado de entidad Receptora'";
    $resultado_6= mysqli_query($conexion_6, $vinculacion);
    $vin = mysqli_fetch_array($resultado_6);
    if($vin){
      ?>
  ...
  <?php 
   ...
   ?>
    ...
    <div class="inf vinculacion">
    <h3 class="Tarea">Cert. del Tutor</h3>
<br>
    <?php 
    $conexion_6= mysqli_connect("localhost", "root", "", "its");
    $vinculacion = "SELECT archivo FROM documentos WHERE id_estudiante= '$id_est' and titulo= 'Certificado del Tutor'";
    $resultado_6= mysqli_query($conexion_6, $vinculacion);
    $vin = mysqli_fetch_array($resultado_6);
    if($vin){
      ?>
  ...
  <?php 
   ...
   ?>
    ...
    <div class="inf vinculacion">
    <h3 class="Tarea">Cert. de Coordinación</h3>

    <?php 
    $conexion_6= mysqli_connect("localhost", "root", "", "its");
    $vinculacion = "SELECT archivo FROM documentos WHERE id_estudiante= '$id_est' and titulo= 'Certificado de Coordinación'";
    $resultado_6= mysqli_query($conexion_6, $vinculacion);
    $vin = mysqli_fetch_array($resultado_6);
    if($vin){
      ?>
